...
class gdalcalc(GdalAlgorithm):
    ...
    def getConsoleCommands(self, parameters, context, feedback, executing=True):
        ...
        arguments.append('-A')
        arguments.append(GdalUtils.gdalSourceFromLayer(layer_a))
        ...
        if self.INPUT_B in parameters and parameters[self.INPUT_B] is not None:
            ...
            arguments.append('-B')
            arguments.append(GdalUtils.gdalSourceFromLayer(layer_b))
        ...
        if self.INPUT_C in parameters and parameters[self.INPUT_C] is not None:
            ...
            arguments.append('-C')
            arguments.append(GdalUtils.gdalSourceFromLayer(layer_c))
        ...
        if self.INPUT_D in parameters and parameters[self.INPUT_D] is not None:
            ...
            arguments.append('-D')
            arguments.append(GdalUtils.gdalSourceFromLayer(layer_d))
        ...
        if self.INPUT_E in parameters and parameters[self.INPUT_E] is not None:
            ...
            arguments.append('-E')
            arguments.append(GdalUtils.gdalSourceFromLayer(layer_e))
        ...
        if self.INPUT_F in parameters and parameters[self.INPUT_F] is not None:
            ...
            arguments.append('-F')
            arguments.append(GdalUtils.gdalSourceFromLayer(layer_f))
