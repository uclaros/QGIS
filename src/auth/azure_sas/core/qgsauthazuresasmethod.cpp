...
#include "qgsauthazuresasmethod.h"
#include "moc_qgsauthazuresasmethod.cpp"
...
const QString QgsAuthAzureSasMethod::AUTH_METHOD_KEY = QStringLiteral( "AzureSAS" );
const QString QgsAuthAzureSasMethod::AUTH_METHOD_DESCRIPTION = QStringLiteral( "Azure SAS tokens" );
const QString QgsAuthAzureSasMethod::AUTH_METHOD_DISPLAY_DESCRIPTION = tr( "Azure SAS tokens" );

QMap<QString, QgsAuthMethodConfig> QgsAuthAzureSasMethod::sAuthConfigCache = QMap<QString, QgsAuthMethodConfig>();


QgsAuthAzureSasMethod::QgsAuthAzureSasMethod()
{
  setVersion( 2 );
...
QString QgsAuthAzureSasMethod::key() const
{
  return AUTH_METHOD_KEY;
}

QString QgsAuthAzureSasMethod::description() const
{
  return AUTH_METHOD_DESCRIPTION;
}

QString QgsAuthAzureSasMethod::displayDescription() const
{
  return AUTH_METHOD_DISPLAY_DESCRIPTION;
}

bool QgsAuthAzureSasMethod::updateNetworkRequest( QNetworkRequest &request, const QString &authcfg, const QString &dataprovider )
{
...
void QgsAuthAzureSasMethod::clearCachedConfig( const QString &authcfg )
{
  removeMethodConfig( authcfg );
}

void QgsAuthAzureSasMethod::updateMethodConfig( QgsAuthMethodConfig &config )
{
  Q_UNUSED( config );
  // NOTE: add updates as method version() increases due to config storage changes
}

QgsAuthMethodConfig QgsAuthAzureSasMethod::getMethodConfig( const QString &authcfg, bool fullconfig )
{
...
void QgsAuthAzureSasMethod::putMethodConfig( const QString &authcfg, const QgsAuthMethodConfig &config )
{
  const QMutexLocker locker( &mMutex );
...
void QgsAuthAzureSasMethod::removeMethodConfig( const QString &authcfg )
{
  const QMutexLocker locker( &mMutex );
  if ( sAuthConfigCache.contains( authcfg ) )
  {
...
#ifdef HAVE_GUI
QWidget *QgsAuthAzureSasMethod::editWidget( QWidget *parent ) const
{
  return new QgsAuthAzureSasEdit( parent );
}
#endif
...
{
  return new QgsAuthAzureSasMethodMetadata();
}
#endif
